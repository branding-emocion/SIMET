...
const Login = () => {
  ...
  const [showPasswordResetModal, setShowPasswordResetModal] = useState(false); // Added states for password recovery modal
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      ...
      toast("Se ha enviado un email de recuperación a tu correo");
      ...
      if (errorCode === "auth/user-not-found") {
        toast("No existe una cuenta con este email");
      } else if (errorCode === "auth/invalid-email") {
        toast("Email inválido");
      } else {
        toast("Error al enviar el email de recuperación");
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div>
      <div className="absolute top-0 left-0 bg-gradient-to-b from-[#23398f] to-[#f3741f] bottom-0 leading-5 h-full w-full overflow-hidden"></div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#23398f] hover:bg-[#f3741f] text-gray-100 p-3 rounded-lg tracking-wide font-semibold cursor-pointer transition ease-in duration-500"
                >
            ...
            <div className="mt-7 text-center text-xs">
              <span>
                ...
                <Link className="text-[#23398f]" href="/">
                  SIMET
                </Link>
              </span>
            </div>
            ...
            <form onSubmit={handleCompleteRegistration} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="flex-1 bg-[#004f51] hover:bg-[#f3741f] text-white"
                >
      ...
      {showPasswordResetModal && ( // Added password reset modal
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
